  ...
  switch(methodId & 0x3FFFFFFF) {
    case 1: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ReportService.SendReport server method call.", GetCallerInfo());
        SendResponse(service_hash_, methodId, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ReportService.SendReport(bgs.protocol.report.v1.SendReportRequest{{ {} }}).",
      ...
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token, methodId](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ...
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ReportService.SendReport() returned bgs.protocol.NoData{{ {} }} status{} .",
    ...
    case 2: {
      ...
      if (!request.ParseFromArray(buffer.GetReadPointer(), buffer.GetActiveSize())) {
        TC_LOG_DEBUG("service.protobuf", "{} Failed to parse request for ReportService.SubmitReport server method call.", GetCallerInfo());
        SendResponse(service_hash_, methodId, token, ERROR_RPC_MALFORMED_REQUEST);
        return;
      }
      TC_LOG_DEBUG("service.protobuf", "{} Client called server method ReportService.SubmitReport(bgs.protocol.report.v1.SubmitReportRequest{{ {} }}).",
        GetCallerInfo(), request.ShortDebugString());
      std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)> continuation = [token, methodId](ServiceBase* service, uint32 status, ::google::protobuf::Message const* response)
      {
        ASSERT(response->GetDescriptor() == ::bgs::protocol::NoData::descriptor());
        ReportService* self = static_cast<ReportService*>(service);
        TC_LOG_DEBUG("service.protobuf", "{} Client called server method ReportService.SubmitReport() returned bgs.protocol.NoData{{ {} }} status{} .",
          self->GetCallerInfo(), response->ShortDebugString(), status);
        if (!status)
          self->SendResponse(self->service_hash_, methodId, token, response);
        else
...
uint32 ReportService::HandleSendReport(::bgs::protocol::report::v1::SendReportRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ReportService.SendReport({{ {} }})",
    GetCallerInfo(), request->ShortDebugString());
...
uint32 ReportService::HandleSubmitReport(::bgs::protocol::report::v1::SubmitReportRequest const* request, ::bgs::protocol::NoData* response, std::function<void(ServiceBase*, uint32, ::google::protobuf::Message const*)>& continuation) {
  TC_LOG_ERROR("service.protobuf", "{} Client tried to call not implemented method ReportService.SubmitReport({{ {} }})",
    GetCallerInfo(), request->ShortDebugString());
  return ERROR_RPC_NOT_IMPLEMENTED;
}
