...
//        flying = false;
//        spawn = 0;
//        me->SetHomePosition(me->GetCreatureData()->spawnPoint.GetPositionX(), me->GetCreatureData()->spawnPoint.GetPositionY(), me->GetCreatureData()->spawnPoint.GetPositionZ(), me->GetCreatureData()->spawnPoint.GetOrientation());
//    }
...
//        else spawn -= diff;
//
//        if ((me->GetPositionZ() - me->GetCreatureData()->spawnPoint.GetPositionZ()) >= 20.0f)
//        {
//            me->DisappearAndDie();
...
//    {
//        _worgenID = action;
//        uint32 _currentPoint = 0;
//        switch (_worgenID)
//        {
//            case WORGEN_ID_ROOF_1:
//                _wayPointCounter = runtHousePathSize1;
//                me->GetMotionMaster()->MovePoint(_currentPoint, worgenRuntHousePath1[_currentPoint]);
//                break;
//            case WORGEN_ID_ROOF_2:
//                _wayPointCounter = runtHousePathSize2;
//                me->GetMotionMaster()->MovePoint(_currentPoint, worgenRuntHousePath2[_currentPoint]);
//                break;
//            case WORGEN_ID_ROOF_3:
//                _wayPointCounter = runtHousePathSize3;
//                me->GetMotionMaster()->MovePoint(_currentPoint, worgenRuntHousePath3[_currentPoint]);
//                break;
//            case WORGEN_ID_ROOF_4:
//                _wayPointCounter = runtHousePathSize4;
//                me->GetMotionMaster()->MovePoint(_currentPoint, worgenRuntHousePath4[_currentPoint]);
//                break;
//            case WORGEN_ID_ROOF_5:
//                _wayPointCounter = runtHousePathSize5;
//                me->GetMotionMaster()->MovePoint(_currentPoint, worgenRuntHousePath5[_currentPoint]);
//                break;
//            case WORGEN_ID_ROOF_6:
//                _wayPointCounter = runtHousePathSize6;
//                me->GetMotionMaster()->MovePoint(_currentPoint, worgenRuntHousePath6[_currentPoint]);
//                break;
//            case WORGEN_ID_ROOF_7:
//                _wayPointCounter = runtHousePathSize7;
//                me->GetMotionMaster()->MovePoint(_currentPoint, worgenRuntHousePath7[_currentPoint]);
//                break;
