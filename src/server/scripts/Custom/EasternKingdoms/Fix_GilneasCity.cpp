...
//                    npc->HandleEmoteCommand(RAND(EMOTE_ONESHOT_COWER, EMOTE_STATE_TALK, EMOTE_ONESHOT_CRY, EMOTE_ONESHOT_BEG, EMOTE_ONESHOT_EXCLAMATION, EMOTE_ONESHOT_POINT));
//
...
//    RegisterCreatureAI(npc_gilneas_city_guard_gate);
//    RegisterCreatureAI(npc_prince_liam_greymane);
...
//    RegisterCreatureAI(npc_josiah_avery_worgen_form);
//    RegisterCreatureAI(spell_gilneas_pull_to);
//    RegisterCreatureAI(npc_lorna_crowley_basement);
//    RegisterCreatureAI(npc_gilnean_mastiff);
//    RegisterCreatureAI(npc_bloodfang_lurker);
//    new spell_script<spell_attack_lurker>("spell_attack_lurker");
//    new npc_king_genn_greymane();
//    new npc_vehicle_genn_horse();
//    RegisterCreatureAI(npc_saved_aranas);
//    RegisterCreatureAI(npc_duskhaven_watchman);
//    RegisterCreatureAI(npc_forsaken_invader);
//    RegisterCreatureAI(npc_forsaken_footsoldier);
...
//    RegisterCreatureAI(npc_chance_the_cat);
//    new npc_mountain_horse("npc_mountain_horse");
//    RegisterCreatureAI(npc_mountain_horse_summoned);
//    new spell_script<spell_gilneas_test_telescope>("spell_gilneas_test_telescope");
//    RegisterCreatureAI(npc_stagecoach_carriage_exodus);
//    RegisterCreatureAI(npc_stagecoach_harness);
//    RegisterCreatureAI(npc_koroth_the_hillbreaker);
